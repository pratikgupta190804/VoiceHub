        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (!isVoting) e.target.style.backgroundColor = "#ec8b0a";
              }}
              onMouseLeave={(e) => {
            ...
            <button
              ...
              onMouseEnter={(e) => (e.target.style.backgroundColor = "#ec8b0a")}
              onMouseLeave={(e) =>
            ...
            <button
              ...
              className="flex items-center space-x-2 px-3 py-2 text-gray-600 hover:text-white rounded-lg transition-all duration-200"
              onMouseEnter={(e) => (e.target.style.backgroundColor = "#ec8b0a")}
              onMouseLeave={(e) =>
                (e.target.style.backgroundColor = "transparent")
              }
                ...
                <div className="mt-2 flex justify-end">
                  <button
                    ...
                    style={{
                      ...
                      hover: { backgroundColor: "#d17808" },
                    }}
                    onMouseEnter={(e) => {
                      if (!e.target.disabled)
                        e.target.style.backgroundColor = "#d17808";
                    }}
                    onMouseLeave={(e) => {
                      if (!e.target.disabled)
                        e.target.style.backgroundColor = "#ec8b0a";
                    }}
                  >
                    {isCommenting
                      ? "Posting..."
